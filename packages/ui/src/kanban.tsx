...
import { Button, buttonVariants } from "./components/blocks/button";
...
export interface KanbanBoardDndMonitorEventHandler {
...
export interface KanbanBoardDndMonitorContextValue {
...
export interface KanbanBoardAnnouncements {
...
export interface KanbanBoardLiveRegionProps {
  id: string;
  announcement: string;
...
export interface KanbanBoardHiddenTextProps {
  id: string;
  value: string;
}
...
export interface KanbanBoardAccessibilityProps {
...
export interface KanbanBoardColumnTitleProps {
  columnId: string;
}
...
export interface KanbanBoardColorCircleProps {
...
export interface KanbanBoardColumnListItemProps {
  cardId: string;
  onDropOverListItem?: (
...
export function KanbanBoardColumnButton({
  ...
  return (
    <Button
      className={cn(
        "bg-sidebar w-full justify-start text-primary hover:text-primary/80",
        className,
      )}
      variant="outline"
      size="sm"
...
export interface KanbanBoardCardButtonGroupProps {
  disabled?: boolean;
}
...
export interface KanbanBoardCardButtonProps {
  tooltip?: string;
}
