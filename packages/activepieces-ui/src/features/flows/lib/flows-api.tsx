...
export const flowsApi = {
  async list(request: ListFlowsRequest): Promise<SeekPage<PopulatedFlow>> {
    const result = await api.get<SeekPage<PopulatedFlow>>('/v1/flows', request);
    console.log('[flowsApi.list] result', result);
    return result;
  },
